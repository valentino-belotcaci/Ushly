...
-- CreateIndex
CREATE INDEX "links_user_created_at_idx" ON "Link"("userId", "createdAt", "id");

-- CreateIndex
CREATE INDEX "clicks_link_clicked_at_idx" ON "Click"("linkId", "clickedAt");
...
-- CreateIndex
CREATE INDEX "refresh_tokens_user_revoked_expires_idx" ON "RefreshToken"("userId", "revokedAt", "expiresAt");
